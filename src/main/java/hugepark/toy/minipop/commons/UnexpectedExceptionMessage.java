...
public class UnexpectedExceptionMessage {
	...
	public static UnexpectedExceptionMessage build(HttpServletRequest req, HttpStatus status, Exception e) {
		UnexpectedExceptionMessage error = new UnexpectedExceptionMessage();
